...
<body>
	<div>
		<div class="img">
			<img src="..//image/bar_03.gif" width="1950px" height="50px" >
		</div>
		<div style="position:absolute; z-index:20; left:199px; top:20px ;color:white ; font-size:20px;">		
	...
	　		仓库存储系统
		...
		<div class="course">
			<div class="course_01">
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp出入库<br>
			</div>
			...
			<div class="course_01">
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp材料管理<br>
			</div>
			<img alt="" src="..//image/bar_02.gif">
			...
			<div class="course_01">
				&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp员工管理<br>
			</div>
			<img alt="" src="..//image/bar_02.gif">
		...
		<div class="content">
			<iframe name="aaa"  width="1770px" height="700px" src="../homepage/indexHomepage.jsp";></iframe >
		</div>
